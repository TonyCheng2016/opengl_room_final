...
out vec3 v3L2; // 輸出 Light2 Direction 在鏡頭座標下的方向
...
uniform vec4  LightINView2;//light2 position in View Space
void main()
{
	...
	v3L2= vec3(LightINView2.xyz - vPosInView.xyz);//light2 v3L2
