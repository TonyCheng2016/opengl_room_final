...
protected:
	...
	//---------------------light2-------------------------
	point4  m_vLightInView2;	 // 光源2在世界座標的位置
	GLuint  m_uiLightInView2;	 // 光源2在 shader 的位置
	GLuint  m_uiAmbient2;		 // light2's ambient  與 Object's ambient  與 ka 的乘積
	GLuint  m_uiDiffuse2;		 // light2's diffuse  與 Object's diffuse  與 kd 的乘積
	GLuint  m_uiSpecular2;		 // light2's specular 與 Object's specular 與 ks 的乘積
	LightSource m_Light2;		 //light2
	...
	//--------------light2------------
	color4 m_AmbientProduct2;	 //light2 a
	color4 m_DiffuseProduct2;	 //light2 d
	color4 m_SpecularProduct2;	 //light2 s
	// For Matrices
...
public:
	...
	vec4 PhongReflectionModelTwoLights(vec4 vPoint, vec3 vNormal, const LightSource &Lights1, const LightSource &Lights2);//light1 and light2
