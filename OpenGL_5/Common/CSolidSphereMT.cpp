...
// 回家自己寫
void CSolidSphereMT::RenderWithFlatShading(const LightSource &lights)
{


}

void CSolidSphereMT::RenderWithGouraudShading(const LightSource &lights)
{
...
void CSolidSphereMT::Update(float dt, const LightSource &lights)
{
	if( m_bMVUpdated  ) {
